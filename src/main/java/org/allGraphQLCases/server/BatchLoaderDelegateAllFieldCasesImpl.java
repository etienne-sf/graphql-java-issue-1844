 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<AllFieldCases>> friends(DataFetchingEnvironment environment, DataLoader<UUID, AllFieldCases> dataLoader,
 ...
 */
@Component
public class BatchLoaderDelegateAllFieldCasesImpl implements BatchLoaderDelegate<UUID, AllFieldCases> {
	 ...
	 * @return the list of AllFieldCasess corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<AllFieldCases>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateAllFieldCases.batchLoader(keys));
	}
