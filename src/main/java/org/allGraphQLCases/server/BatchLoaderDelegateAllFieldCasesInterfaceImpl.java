 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<AllFieldCasesInterface>> friends(DataFetchingEnvironment environment, DataLoader<UUID, AllFieldCasesInterface> dataLoader,
 ...
 */
@Component
public class BatchLoaderDelegateAllFieldCasesInterfaceImpl implements BatchLoaderDelegate<UUID, AllFieldCasesInterface> {
	 ...
	 * @return the list of AllFieldCasesInterfaces corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<AllFieldCasesInterface>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateAllFieldCasesInterface.batchLoader(keys));
	}
