 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<AllFieldCasesWithIdSubtype>> friends(DataFetchingEnvironment environment, DataLoader<UUID, AllFieldCasesWithIdSubtype> dataLoader,
 * 		AllFieldCasesWithIdSubtype source) {
 ...
 */
@Component
public class BatchLoaderDelegateAllFieldCasesWithIdSubtypeImpl implements BatchLoaderDelegate<UUID, AllFieldCasesWithIdSubtype> {
	 ...
	 * @return the list of AllFieldCasesWithIdSubtypes corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<AllFieldCasesWithIdSubtype>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateAllFieldCasesWithIdSubtype.batchLoader(keys));
	}
