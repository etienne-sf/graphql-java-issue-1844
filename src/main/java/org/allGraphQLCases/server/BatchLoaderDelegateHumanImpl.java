 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Human>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Human> dataLoader,
 * 		Human source) {
...
public class BatchLoaderDelegateHumanImpl implements BatchLoaderDelegate<UUID, Human> {
	...
	public CompletionStage<List<Human>> load(List<UUID> keys) {
		...
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateHuman.batchLoader(keys));
	}
