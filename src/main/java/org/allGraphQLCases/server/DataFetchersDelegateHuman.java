 ...
 */
public interface DataFetchersDelegateHuman {
	
	/**
	 * This method loads the data for Human.bestFriend. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the bestFriend attribute
	 *    of the <I>origin</I>, which is an instance of {Human}. It depends on your data modle, but it typically contains 
	 ...
	 * <PRE>
	 * @Override
	 * public CompletableFuture<List<Character>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Character> dataLoader, Human origin) {
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public CompletableFuture<Character> bestFriend(DataFetchingEnvironment dataFetchingEnvironment, DataLoader<UUID, Character> dataLoader, Human origin);
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public List<Character> friends(DataFetchingEnvironment dataFetchingEnvironment, Human origin);

	/**
	 * This method loads the data for Human.comments. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public List<String> comments(DataFetchingEnvironment dataFetchingEnvironment, Human origin);
	 ...
	 *     whether or not there is a value. The generated code will take care of the {@link NoSuchElementException} exception. 
	 */
	public List<Episode> appearsIn(DataFetchingEnvironment dataFetchingEnvironment, Human origin);
