 ...
 */
@Component
public class BatchLoaderDelegateWithIDImpl implements BatchLoaderDelegate<UUID, WithID> {
	 ...
	 * @return the list of WithIDs corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<WithID>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateWithID.batchLoader(keys));
	}
